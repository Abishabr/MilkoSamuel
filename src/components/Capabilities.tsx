...
export default function Capabilities({ isFullView = false, onContactClick, onJournalClick }: CapabilitiesProps) {
  ...
  const fallbackServices = [
    { id: "1", title: "GRAPHIC DESIGN", description: "Creating striking typography hierarchies, high-contrast print materials, elegant packaging systems, and digital posters.", iconName: "PenTool", order: 1 },
    { id: "2", title: "VIDEO EDITING", description: "Polishing dynamic short-form videos, commercials, visual loops, and multi-track timelines with rhythmic cuts.", iconName: "Video", order: 2 },
    { id: "3", title: "BRAND IDENTITY", description: "Designing iconic logos, tailored color systems, visual guidelines, and cohesive vector systems.", iconName: "Fingerprint", order: 3 },
    { id: "4", title: "MOTION GRAPHICS", description: "Breathing life into visual assets with vector kinetic type, elegant title transitions, and logo animations.", iconName: "Zap", order: 4 },
    { id: "5", title: "DIGITAL ASSETS", description: "Providing social media templates, banners, visual presentation slide systems, and custom graphics.", iconName: "Layout", order: 5 }
  ];
        ...
        <section className="px-6 lg:px-16 max-w-7xl mx-auto py-16">
          <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 border-l border-t transition-colors duration-300 ${
            ...
            {activeServices.map((service, index) => {
              const IconComponent = iconMap[service.icon || service.iconName] || PenTool;
              return (
                <motion.div
