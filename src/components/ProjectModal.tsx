                ...
                <div className={`grid grid-cols-2 gap-4 border-t pt-6 transition-colors duration-300 ${
                  ...
                  <div className={`flex items-center space-x-3 ${isLight ? "text-gray-600" : "text-gray-400"}`}>
                    ...
                    <div>
                      ...
                      <p className={`text-xs font-sans font-bold ${isLight ? "text-black" : "text-white"}`}>{project.category}</p>
                    </div>
                  </div>
                  ...
                  <div className={`flex items-center space-x-3 ${isLight ? "text-gray-600" : "text-gray-400"}`}>
                    ...
                    <div>
                      ...
                      <p className={`text-xs font-sans font-bold ${isLight ? "text-black" : "text-white"}`}>{project.year}</p>
                    </div>
                  </div>
                  ...
                  <div className={`flex items-center space-x-3 ${isLight ? "text-gray-600" : "text-gray-400"}`}>
                    ...
                    <div>
                      <p className={`text-[9px] font-mono tracking-widest uppercase ${isLight ? "text-gray-500" : "text-gray-600"}`}>Duration</p>
                      <p className={`text-xs font-sans font-bold ${isLight ? "text-black" : "text-white"}`}>{project.duration}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className={`grid grid-cols-1 md:grid-cols-3 gap-8 pt-6 border-t transition-colors duration-300 ${
              ...
              <div className="space-y-4">
                ...
                <p className={`text-xs md:text-sm leading-relaxed font-sans ${
                  ...
                  {project.challenge || "To reposition the brand and deliver extreme focus into their target client demographic with unique architectural layouts and minimalist style rules."}
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className={`text-xs md:text-sm leading-relaxed font-sans ${
                  ...
                  {project.solution || "We crafted a geometric branding system and combined high-contrast fullscreen responsive modules to simplify density and enrich digital presence."}
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className={`text-xs md:text-sm leading-relaxed font-sans ${
                  ...
                  {project.outcome || "Repositioned target brand, resulting in over 140% surge in customer engagement queries, positive feedback loop, and design layout award honors."}
                </p>
              </div>
            </div>
