...
I help forward-thinking brands and ambitious creators turn chaotic ideas into clean, eye-catching, and high-performance realities.`;
  ...
  const defaultPhilosophy = [
    { title: "Clarity", description: "Simplicity is not minimalism. It is making the complex feel entirely effortless and transparent." },
    { title: "Function", description: "Design must serve a strategic purpose first, removing friction and guiding user interaction naturally." },
    { title: "Impact", description: "Great design leaves an indelible, lasting visual memory and drives measurable growth and outcomes." }
  ];
