// Legacy static data — will be replaced by Supabase queries in src/lib/supabase.ts.
// The typed imports from ./types have been removed because the interfaces now use
// snake_case Supabase column names (see Task 3). These arrays retain their shape
// temporarily and will be deleted as part of Task 11 (legacy file removal).
...
export const softwareEcosystem = [
